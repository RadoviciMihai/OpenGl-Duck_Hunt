...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(-0.5, -0.5, 0.5), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, -0.5, 0.5), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(-0.5, 0.5, 0.5), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5, 0.5, 0.5), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(-0.5, -0.5, -0.5), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
    ...
    }
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6))
            // TODO(student): Complete the vertices data for the cube mesh
        ...
        meshes["tri_A"] = new Mesh("generated tri 1");
        meshes["tri_A"]->InitFromData(vertices, indices);

        // Actually create the mesh from the data
        CreateMesh("tri_B", vertices, indices);
    }
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.4, 0.8, 0.6))
            // TODO(student): Complete the vertices data for the cube mesh
        ...
        meshes["sq_A"] = new Mesh("generated sq 1");
        meshes["sq_A"]->InitFromData(vertices, indices);

        // Actually create the mesh from the data
        CreateMesh("sq_B", vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    glCullFace(GL_FRONT);
    if (window->KeyHold(GLFW_KEY_F2)) glCullFace(GL_BACK);
    ...
    RenderMesh(meshes["cube_A"], shaders["VertexColor"], glm::vec3(-1.1f, 0.5f, 0), glm::vec3(0.25f));

    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-3.1f, 0.5f, 0), glm::vec3(0.25f));
    RenderMesh(meshes["tri_B"], shaders["VertexColor"], glm::vec3(-2.1f, 0.5f, 0), glm::vec3(0.25f));
    RenderMesh(meshes["sq_B"], shaders["VertexColor"], glm::vec3(-2.1f, 3.5f, 0), glm::vec3(0.25f));
