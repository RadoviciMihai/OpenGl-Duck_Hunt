...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-2,5, 0))*glm::scale(modelMatrix, glm::vec3(2, 5, 3));
        RenderMesh(meshes["box"], shaders["Simple"], modelMatrix);
    }
    
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-2, 2, 5)) * glm::rotate(modelMatrix, RADIANS(1), glm::vec3(2, 5, 3));
        RenderMesh(meshes["box"], shaders["Simple"], modelMatrix);
    }
